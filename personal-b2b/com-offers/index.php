...
$arItemOrder = [];
if($request['NUMBER']){
    $arrFilter['%PROPERTY_NUMBER'] = $request['NUMBER'];
}
if($request['PHONE']){
    $arrFilter['%PROPERTY_PHONE'] = $request['PHONE'];
}
...
if($request['filter']){
    $arrFilter[$request['filter']] = $request['value'];
}
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPONENT_TEMPLATE" => "b2b-com-offers"
	),
	false
); ?>
