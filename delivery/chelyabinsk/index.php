...
$APPLICATION->SetPageProperty("title", "Белорусские межкомнатные двери - купить в Челябинске");
$APPLICATION->SetPageProperty("keywords", "межкомнатные двери, белоруссия, доставка, челябинск");
$APPLICATION->SetPageProperty("description", "Межкомнатные двери Belwooddoors от производителя с доставкой в Челябинск через сторонних подрядчиков");
$APPLICATION->SetTitle("Межкомнатные двери Belwooddoors с доставкой в Челябинск");
?><section class="about">
<p>
	 Мы можем организовать доставку наших дверей в Челябинск с помощью услуг транспортных компаний на ваш выбор.
</p>
<p>
