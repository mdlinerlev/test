...
$APPLICATION->SetPageProperty("title", "Межкомнатные белорусские двери - купить в Санкт-Петербурге");
$APPLICATION->SetPageProperty("keywords", "межкомнатные двери, белоруссия, доставка, Санкт-Петербург");
$APPLICATION->SetPageProperty("description", "Межкомнатные двери Belwooddoors от производителя с доставкой в Санкт-Петербург через сторонних подрядчиков");
$APPLICATION->SetTitle("Межкомнатные двери Belwooddoors с доставкой в Санкт-Петербург");
?><section class="about">
<p>
	 Мы можем организовать доставку наших дверей в Санкт-Петербург с помощью услуг транспортных компаний на ваш выбор.
</p>
<p>
