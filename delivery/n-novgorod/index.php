...
$APPLICATION->SetPageProperty("title", "Межкомнатные белорусские двери - купить в Нижний Новгород");
$APPLICATION->SetPageProperty("keywords", "межкомнатные двери, белоруссия, доставка, нижний новгород");
$APPLICATION->SetPageProperty("description", "Межкомнатные двери Belwooddoors от производителя с доставкой в Нижний Новгород через сторонних подрядчиков");
$APPLICATION->SetTitle("Межкомнатные двери Belwooddoors с доставкой в Нижний Новгород");
?><section class="about">
<p>
	 Мы можем организовать доставку наших дверей в Нижний Новгород с помощью услуг транспортных компаний на ваш выбор.
</p>
<p>
