	...
	<table class="header">
		<tr>
            ...
            <td style="text-align: center; font-size: small;">
                <b>Внимание! Оплата данного счета означает согласие с условиями поставки товара. Уведомление об оплате
                    обязательно, в противном случае не гарантируется наличие товара на складе. Товар отпускается по факту прихода денег на р/с Поставщика,
...
<br>
	...
	<?=nl2br(HTMLToTxt(preg_replace(
        ...
        <br>
        Счет действителен в течении 3 банковских дней от даты выставления
        <br>
