...
<footer class="footer" data-landingId="<?=LANDING_ID?>">
        ...
        <div class="content-container content-container--orange">
            <div class="footer--orange">
                <div class="subscribe subscribe--white">
                    <form   action="https://doordesignlab.us19.list-manage.com/subscribe/post?u=61556c8c94e531765bb2be71f&id=c7f303620d" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                        <div class="subscribe__title">
                            Рассылка для оптовых покупателей и партнеров
                        </div>
                        <div class="subscribe__form">
                            <div class="subscribe__group">
                                <input type="email" value="" name="EMAIL" class="required email subscribe_email" placeholder="Электронная почта" id="mce-EMAIL">
                                <div class="response" id="mce-error-response">Неверный email</div>
                                <input type="submit" value="Подписаться" name="subscribe" id="mc-embedded-subscribe" class="btn subscribe_button">
                            </div>
...
<!--                </div>-->
            ...
            <div class="footer-section__menu">
                ...
                <div class="footer-section__contacts">
                  ...
                  ?>
	                ...
	                <img src="<?= SITE_TEMPLATE_PATH . '/preload.svg'?>" data-src="/upload/visa.png" class="owl-lazy" alt="способы оплаты">
            ...
            <div class="text_about_shop">
                <div class="tabs">
                    <div class="tab">
                        ...
                        <label class="tab-label" for="chck_about">
                            О магазине&nbsp;
                            <svg class="tab-arrow"><use xlink:href="#arrow-down"></use></svg>
                        </label>
	...
	false
		        ...
		        ?>
		        <img  class="lazy"  src="<?= SITE_TEMPLATE_PATH . '/preload.svg'?>" data-src="/upload/visa.png" alt="способы оплаты">
	        </div>
...
<script>
    ...
    })(window,document,'https://bitrix.belwood.ru/upload/crm/site_button/loader_1_676y0h.js');
</script>


<script src="/bitrix/templates/general/js/b24_livechat.js"></script>
