    ...
    <?foreach($arResult["ITEMS"] as $key => $arItem):?>
        ...
        <article class="news__item">
            ...
            <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="news__inner">
                ...
                <div class="news-tags">
                    <?php foreach($arItem['PROPERTIES']['TAGS']['VALUE_ENUM'] as $k => $tagName): ?>

                        <div class="news-tag">
                            <span class="my_custom_filter" onclick="location.href='/articles/?tag=<?=$arResult["ITEMS"][$key]['PROPERTIES']['TAGS']['VALUE_ENUM_ID'][$k]?>'; return false;"   >
                                    <?= $tagName ?>
                            </span>
                        </div>
                    <?php endforeach ?>
