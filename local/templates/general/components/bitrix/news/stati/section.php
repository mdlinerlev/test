...
<section class="article-cat">
    <div class="article-cat__list">
        <?php foreach ($arResult['sectionStati'] as $sectionCode => $nameSection):?>
            <a class="article-cat__li <? if($counter > 10):?> _hidden <? endif ?>" href="<? echo '/articles/' . $sectionCode ?>/">
        ...
        <? if($counter > 10): ?>
            <button class="article-cat__btn">Показать еще</button>
        <? endif ?>
    </div>
</section>
<!--end TASK 53835 -->
