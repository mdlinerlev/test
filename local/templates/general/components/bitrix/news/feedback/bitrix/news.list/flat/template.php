...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="feedback__inner" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <div class="feedback__title"><?=$arItem["NAME"]?>
                  </div>
                  ...
                  <div class="feedback__text"><?=$arItem["DETAIL_TEXT"]?>
                  </div>
                  <a href="<?=$SITE_DIR.$arItem["DETAIL_PAGE_URL"]?>" class="feedback__link">Читать далее
                  </a>
