...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
        <article class="offers__item">
            <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="offers__inner">
	            <img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" alt="">
<!--                <a class="offers__button offers__button--readmore button">-->
<!--                 Подробнее  </a>-->
                 
                  <?/*<div class="news__date">
                      <?list($day,$month,$year) = explode(" ", $arItem["DISPLAY_ACTIVE_FROM"]);?>
                    <span class="news__date-number"><?echo $day?>
                    </span><?echo $month?>
                  </div>
