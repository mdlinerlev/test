...
{
    ?>
<a rel="nofollow" id="<? echo $idCompareCount; ?>" class="header-shop-links__link header-shop-links__link--comparsion active" href="<? echo $arParams["COMPARE_URL"]; ?>">
    <svg class="icon icon-chart">
        <use xlink:href="#bar-chart"></use>
    </svg>
      <div class="header-shop-links__badge" id="<? echo $idCompareAll; ?>"><? echo $itemCount; ?></div>
      <div class="header-shop-links__text header-shop-links__text--comparsion">Сравнение</div>  
    </a><?
}else{?>
    <a rel="nofollow" href="<? echo $arParams["COMPARE_URL"]; ?>" class="header-shop-links__link header-shop-links__link--comparsion">

        <div class="header-shop-links__text header-shop-links__text--comparsion">
        </div>
    </a>
<?}
?><?
