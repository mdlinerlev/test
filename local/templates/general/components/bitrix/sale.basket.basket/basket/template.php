...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	{
		?>
		<div style="margin-top: 35px;"><? $APPLICATION->IncludeComponent("bitrix:sale.gift.basket", "basket_gift", Array(
	"SHOW_PRICE_COUNT" => "1",	// Выводить цены для количества
		...
		"HIDE_BLOCK_TITLE" => "N",	// Скрыть заголовок "Подарки"
		...
		"SHOW_NAME" => "N",	// Показывать название
		"SHOW_IMAGE" => "N",	// Показывать изображение
		...
		"PRICE_CODE" => "",	// Тип цены
		"SHOW_PRODUCTS_2" => "N",	// Показывать товары каталога
		"PROPERTY_CODE_2" => "",	// Свойства для отображения
		"CART_PROPERTIES_2" => "",	// Свойства для добавления в корзину
