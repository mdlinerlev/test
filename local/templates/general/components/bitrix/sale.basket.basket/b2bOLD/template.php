...
$this->addExternalJs($templateFolder.'/lib/jquery-ui.min.js');
$this->addExternalCss($templateFolder.'/lib/jquery-ui.min.css');
...
if (empty($arResult['ERROR_MESSAGE'])) {
    ...
    <div id="basket-root" class="b2b-basket bx-step-opacity" style="opacity: 0;">
        <?
        if (
        ...
        <div class="b2b-basket__content">
            <div class="b2b-basket__wrp" id="basket-items-list-container">
                <div class="basket-items-list-overlay" id="basket-items-list-overlay" style="display: none;"></div>
                <div class="b2b-basket__table" id="basket-item-list">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <th style="width: 25%">Информация о товаре</th>
                            <th style="width: 14%">Статус</th>
                            <th style="width: 14%">Цена</th>
                            <th style="width: 16%">Количество</th>
                            <th style="width: 14%">Итого цена</th>
                            <th class="_empty" style="width: 5%"></th>
                        </tr>
                        </thead>
                        ...
                        foreach ($arResult['BASKET_ITEM_RENDER_DATA'] as $item) {
                            $arHlElements = HLHelpers::getInstance()->getElementList(6, ['UF_ID' => $item['ID'], 'UF_PRODUCT_ID' => $item['PRODUCT_ID']]);
                            if(($arHlElements[0]['UF_HEIGHT'] && $arHlElements[0]['UF_WIDTH']) || $arHlElements[0]['UF_COLOR']) $text .= $item['NAME'];
                ...
                <div class="tab-panels">
                    <div class="basket_order__descr">
                        <div class="basket__float-comment">
                            <div class="toggled-elem"> Комментарий к заказу <svg class="dropdown_arrow"><use xlink:href="#arrow-up"></use></svg></div>
                            <textarea class="toggled-item" name="PROP[COMMENT]" cols="30" rows="3"><?=$text?></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        if (
            ...
            ?>
            <div class="b2b-basket__sidebar">
                <div class="b2b-basket__total-wrp" data-entity="basket-total-block"></div>
            </div>
            <?
        }
        ?>
