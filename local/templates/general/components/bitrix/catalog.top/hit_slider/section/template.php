...
global $APPLICATION;
?>
<section class="items-slider items-slider--hits">
    <div class="content-container">
	    <div class="items-slider__title-container">
		    <div class="items-slider__title">Хиты продаж</div>
		    <a href="<?=SITE_DIR?>hit/" class="items-slider__button items-slider__button--all-button">
			    <span>Все хиты</span>
		    </a>
	    </div>
                ...
                <div class="catalog-item__inner" id="<? echo $strMainID; ?>">
                    <div class="catalog-item__image-container">
                        <div>
                            ...
                            <a id="<? echo $arItemIDs['PICT']; ?>"
                               href="<? echo $arItem['DETAIL_PAGE_URL'] . '#offer' . $arItem['OFFERS'][0]['ID']; ?>"
                    ...
                    if ($arItem['SECOND_PICT']) {
                        ...
                        <a id="<? echo $arItemIDs['SECOND_PICT']; ?>"
                           href="<? echo $arItem['DETAIL_PAGE_URL'] . '#offer' . $arItem['OFFERS'][0]['ID']; ?>"
                           class="bx_catalog_item_images_double" style="background-image: url('<?
                        echo(
                    ...
                    ?>
                    <div class="catalog-item__title-container"><a class="catalog-item__title"
                                                                  href="<? echo $arItem['DETAIL_PAGE_URL'] . '#offer' . $arItem['OFFERS'][0]['ID']; ?>"
                    ...
                    <div class="catalog-item__price">
                        ...
                        if (!empty($minPrice)) {
                            ...
                            if ('Y' == $arParams['SHOW_OLD_PRICE'] && $minPrice['DISCOUNT_VALUE'] < $minPrice['VALUE']) {
                                ?>
                                <div class="catalog-item-price__base"> <span
                                        class="catalog-item-price__number"><? echo $minPrice['PRINT_VALUE']; ?></span>
                    ...
                    <div class="catalog-item__badge-container">
	                    <div class="catalog-item__label catalog-item__label--dark">Хит</div>
                    </div>
                    <?/*
