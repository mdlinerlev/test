...
<section class="items-slider items-slider--discounts">
    <div class="content-container">
        <div class="items-slider__slider">
        <?
        foreach ($arResult['ITEMS'] as $key => $arItem) {
            
            if($arItem["OFFERS"][0]["PROPERTIES"]["OLD_PRICE"]["~VALUE"] > $arItem['MIN_PRICE']["VALUE"]){
            ...
            <div class="catalog-item">
                <div class="catalog-item__inner" id="<? echo $strMainID; ?>">
                    <div class="catalog-item__image-container">
                        <div>
                            <?$file = CFile::ResizeImageGet($arItem['OFFERS'][0]['DETAIL_PICTURE'], array('width'=>135,'height' => 280), BX_RESIZE_IMAGE_PROPORTIONAL, true, $arWaterMark);?>
                    <a id="<? echo $arItemIDs['PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL'].'#offer'.$arItem['OFFERS'][0]['ID']; ?>" class="catalog-item__image-link">
                        <img  src="<?= SITE_TEMPLATE_PATH ?>/preload.svg"  data-src="<? echo $file['src']; ?>" class="catalog-item__image"  alt="<?=$imgAlt ?>" title="<?=$imgTitle ?>">
    ...
    /*if ($arItem['LABEL']) {
        ?>
                        ...
                        if ($arItem['SECOND_PICT']) {
                            ?>
                     <?$file_sec = CFile::ResizeImageGet($arItem['OFFERS'][0]['DETAIL_PICTURE'], array('width'=>135,'height' => 280), BX_RESIZE_IMAGE_PROPORTIONAL, true, $arWaterMark);?>
                    ...
                    <div class="catalog-item__price">
                        ...
                        if (!empty($minPrice)) {
                            if ('N' == $arParams['PRODUCT_DISPLAY_MODE'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS'])) {
                               ...
                               echo '<div class="catalog-item-price__base"><span class="catalog-item-price__number">'.$arItem["OFFERS"][0]["PROPERTIES"]["OLD_PRICE"]["~VALUE"].MAIN_CURRENCY_TEXT.'</span>';
                            } else {
                                echo '<div class="catalog-item-price__discount">'.$minPrice['PRINT_DISCOUNT_VALUE'].'</div>';
                                echo '<div class="catalog-item-price__base"><span class="catalog-item-price__number">'.$arItem["OFFERS"][0]["PROPERTIES"]["OLD_PRICE"]["~VALUE"].MAIN_CURRENCY_TEXT.'</span>';
                            }
                            ...
                            ?>
                                    <span class="catalog-item-price__badge"><?=number_format(((-$arItem["OFFERS"][0]["PROPERTIES"]["OLD_PRICE"]["~VALUE"]+$minPrice['PRINT_DISCOUNT_VALUE'])/($arItem["OFFERS"][0]["PROPERTIES"]["OLD_PRICE"]["~VALUE"]/100)), 0);?> %</span>                                
                            ...
                            unset($minPrice);
                            ?>
<!--<pre><? print_r($arItem["OFFERS"][0]["PROPERTIES"]["OLD_PRICE"]["~VALUE"] )?></pre>--> 
