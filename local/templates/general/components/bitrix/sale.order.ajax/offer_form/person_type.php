...
if(count($arResult["PERSON_TYPE"]) > 1)
{
	...
	<fieldset class="order__fieldset"> 
            <legend class="order__legend"><?=GetMessage("SOA_TEMPL_PERSON_TYPE")?></legend>
            <div class="order__tabs">
		<?foreach($arResult["PERSON_TYPE"] as $v):?>
			<div class="order__radio order__radio--tab-link radio" <?if ($v["CHECKED"]=="Y") echo " checked=\"checked\"";?>>
