...
<fieldset class="order__fieldset order__fieldset--delivery">
    <?
    if (!empty($arResult["DELIVERY"])) {
    $width = ($arParams["SHOW_STORES_IMAGES"] == "Y") ? 850 : 700;
    ?>
    <legend class="order__legend"><?= GetMessage("SOA_TEMPL_DELIVERY") ?></legend>
    <div class="order__radio-buttons">
        ...
        foreach ($arResult["DELIVERY"] as $delivery_id => $arDelivery) {
            ...
            <div class="order__radio radio" <? if ($arDelivery["CHECKED"] == "Y") echo " checked"; ?>>
                            ...
                            <tr>
                                ...
                                <td rowspan="2" class="price">
                                    ...
                                    if ($price = $extraService->getPrice()) {
                                        ...
                                        echo SaleFormatCurrency($price, $arResult['BASE_LANG_CURRENCY']);
                                    }
                                    ?>
                                </td>
                            </tr>
