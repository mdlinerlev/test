...
<fieldset class="order__fieldset">
	...
	<script type="text/javascript">
		...
		{
                    ?><legend class="order__legend"><?=GetMessage("SOA_TEMPL_PAY_SYSTEM")?></legend>
		...
		foreach($arResult["PAY_SYSTEM"] as $arPaySystem)
		{
			if (strlen(trim(str_replace("<br />", "", $arPaySystem["DESCRIPTION"]))) > 0 || intval($arPaySystem["PRICE"]) > 0)
			{
				...
				{
				?>
					<div class="order__radio radio" <?if ($arPaySystem["CHECKED"]=="Y" && !($arParams["ONLY_FULL_PAY_FROM_ACCOUNT"] == "Y" && $arResult["USER_VALS"]["PAY_CURRENT_ACCOUNT"]=="Y")) echo " checked=\"checked\"";?>>
