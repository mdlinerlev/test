...
<div class="b2b-content__wrp">
    <?if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS'])) {?>
        <div class="b2b-material__btn">
            <a class="button js-downloadAllMaterials" href="javascript:void(0)">Скачать все</a>
        </div>
        <?
        $areaIds = array();
        ...
        ?>
        <!-- items-container -->
        <div class="b2b-material">
            <div class="b2b-material__list js-download-all__wrp" data-entity="<?= $containerName ?>">
