...
<?if ($arResult['NUM_PRODUCTS'] > 0){?>
                ...
                <a href="<?=$arParams['PATH_TO_BASKET'] ?>" class="header-fixed-shop-links__link header-fixed-shop-links__link--cart active">

                    <svg class="icon icon-small-cart">
                        <use xlink:href="#shopping_cart_line"></use>
                    </svg>
                    <div class="header-fixed-shop-links__badge"><?=$arResult['NUM_PRODUCTS']?>
                  
                    
                    </div>
                  
                    
                    <div class="header-fixed-shop-links__text"><?=$arResult['TOTAL_PRICE'] ?>
...
<?}else{?>
    ...
    <a href="<?=$arParams['PATH_TO_BASKET'] ?>" class="header-fixed-shop-links__link header-fixed-shop-links__link--cart">
                  <div class="header-fixed-shop-links__text">
                      <svg class="icon icon-small-cart">
                          <use xlink:href="#shopping_cart_line"></use>
                      </svg>
                      Корзина
