...
<?if ($arResult['NUM_PRODUCTS'] > 0){?>
                ...
                <a rel="nofollow" href="<?=$arParams['PATH_TO_BASKET']?>" class="offcanvas-menu-shop-links__link offcanvas-menu-shop-links__link--cart active">
                    <svg class="icon icon-small-cart">
                        <use xlink:href="#shopping_cart"></use>
                    </svg>
                    
                    <div class="offcanvas-menu-shop-links__badge"><?=$arResult['NUM_PRODUCTS']?>
                  
                    
                    </div>
                  
                    
                    <div class="offcanvas-menu-shop-links__text">Корзина
...
<?}else{?>
    ...
    <a rel="nofollow" href="<?=$arParams['PATH_TO_BASKET']?>" class="offcanvas-menu-shop-links__link offcanvas-menu-shop-links__link--cart">
                  <div class="offcanvas-menu-shop-links__text">
