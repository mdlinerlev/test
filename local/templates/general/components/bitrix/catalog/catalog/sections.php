...
?>
    ...
    <div class="catalog__topbar">
        <div class="catalog-categories__text"><h1><?= $APPLICATION->ShowTitle(false); ?></h1></div>
        ...
        <?if(!empty($arCurSection['UF_BANNER'])):?>
            <div class="section-image__container">
                ...
                <a href="<?=$arCurSection['UF_BANNER_LINK'];?>">
                    <?endif;?>
                    <div class="section-image__block" style="background-image: url('<?= CFile::GetPath($arCurSection['UF_BANNER'])?>')"></div>
                    <?if(!empty($arCurSection['UF_BANNER_LINK'])):?>
                </a>
            <?endif;?>
            </div>
