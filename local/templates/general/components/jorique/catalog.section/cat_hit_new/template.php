...
<?
       $aSection = CIBlockSection::GetList(array(), array(
                                        ...
                                        'ID' => $arResult["~ID"],
                                            //'CODE'          => '',
                                            ), false, array('UF_DESCR', 'UF_DESCR_HTML'))->Fetch();
                            ?>
    <? if (!empty($aSection["UF_DESCR"]) || !empty($aSection["UF_DESCR_HTML"])) {?>
        <div class="catalog_txt">
            <?=(!empty($aSection["UF_DESCR_HTML"])) ? $aSection["~UF_DESCR_HTML"] : $aSection["~UF_DESCR"]; ?>
        </div>
    <?}?>
...
?>
		...
		<div>
                    <a id="<? echo $arItemIDs['PICT']; ?>" href="<?echo $arItem['DETAIL_PAGE_URL']; ?>" style="" class="catalog-item__image-link">
                        <img class="catalog-item__image" alt="<? echo $imgTitle; ?>" src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>">
                    </a>                      
               </div>
            </div>
