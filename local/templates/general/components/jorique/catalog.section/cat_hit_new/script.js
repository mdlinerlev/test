...
window.JCCatalogSection.prototype.setPrice = function(price)
{
	...
	if (!!this.obPrice)
	{
		...
		{
			strPrice += '</div><div class="catalog-item-price__base"><span style="color: #e03629;margin-top: 6px; font-size: 12px;" class="catalog-item-price__number">'+BX.Currency.currencyFormat(price.VALUE, price.CURRENCY, true)+'</span>';
		}
