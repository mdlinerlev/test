...
window.JCCatalogSection.prototype.ChangeInfo = function()
{
	...
	if(index >= 0 && this.offers[index]) {
		...
		$('.js-quantity_offer[data-offer-id='+this.product.id+']').html(this.offers[index].MAX_QUANTITY+' '+this.offers[index].MEASURE);
		$('.js-favorite-add[data-item-id='+this.product.id+']').attr('data-id', this.offers[index].ID);
		checkFavorites();
	}
};
