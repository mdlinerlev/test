...
<div id="skyweb24_coupon_coupon_7" style="<?if(!empty($arResult['GOOGLE_FONT'])){?>font-family:<?=$arResult['GOOGLE_FONT']?><?}?>;">
    <div class="row_image">
    ...
    <div class="row_content">
        ...
        <div class="closeb"><a href="javascript:void(0);" class="sw24TextCloseButton"><?=$arResult['CLOSE_TEXTAREA']?></a></div>
    </div>
</div>
    ...
    <script>
        ...
        if(BX)
        {
            BX.ready(function () {
                ...
                let popupContainer = BX("skyweb24_coupon_coupon_7");
