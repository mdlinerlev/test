...
<div id="skyweb24_roulette2" style="<?if(!empty($arResult['GOOGLE_FONT'])){?>font-family:<?=$arResult['GOOGLE_FONT']?><?}?>">
    ...
    <script>
        ...
        async function roll_roulette_func(countSector) {
            ...
            let nodeInputPhone = BX('skyweb24_roulette2').querySelector(`.sw24-roulette-input-phone`);
            let nodeInputEmail = BX('skyweb24_roulette2').querySelector(`.sw24-roulette-input-email`);
        ...
        class RouletteGame {
            ...
            getAwardSectorWheel(numberSector) {
                var text = document.querySelector('#skyweb24_roulette2 div.rotate_block>.text>div:nth-child(' + numberSector + ')').innerHTML;
                var rule = document.querySelector('#skyweb24_roulette2 div.rotate_block>.text>div:nth-child(' + numberSector + ')').dataset.rule;
                var not = document.querySelectorAll('#skyweb24_roulette2 div.rotate_block>.container>div:not(:nth-child(' + numberSector + '))');
            ...
            renderAward(award) {
                if (this.isAwardWin(award.rule)) {
                    BX('skyweb24_roulette2').querySelector(`.result_roll`).style.display = "block";
                } else {
                    BX('skyweb24_roulette2').querySelector(`.result_roll_nothing`).style.display = "block";
                }
            }

            renderErrorMessage(message) {
                BX('skyweb24_roulette2').querySelector(`.sw24-roulette-error-result`).style.display = "block";
                BX('skyweb24_roulette2').querySelector(`.sw24-roulette-error-result`).innerHTML = message;
            }

            removeErrorMessage() {
                BX('skyweb24_roulette2').querySelector(`.sw24-roulette-error-result`).innerHTML = "";
                BX('skyweb24_roulette2').querySelector(`.sw24-roulette-error-result`).style.display = "none";
            }

            removeNodeButtonSend() {
                BX('skyweb24_roulette2').querySelector('.btn-action').remove()
