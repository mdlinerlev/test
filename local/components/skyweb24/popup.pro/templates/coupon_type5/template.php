...
<div id="skyweb24_coupon_type5" style="<?if(!empty($arResult['GOOGLE_FONT'])){?>font-family:<?=$arResult['GOOGLE_FONT']?><?}?>">
...
<?}?>
    ...
    <!--div class="bg" style="background-image:url('<?=$arResult['IMG_1_SRC']?>')">
		<div>
			...
			<span class="sale">
                <?=GetMessage("POPUPPRO_SALE")?> <?=$arResult['PERCENT']?>
            </span>
            <span class="avaliable"><?=GetMessage("POPUPPRO_AVALIABLE")?> <?=$arResult['TIMING']?>
			...
			<div class="coupon_block">
                <button onclick="getCouponC<?=$arParams['ID_POPUP']?>();" class="sw24-button-animate"><?=$arResult['BUTTON_TEXT']?></button>
    ...
    <script>
        ...
        if(BX)
        {
            BX.ready(function () {
                ...
                let popupContainer = BX("skyweb24_coupon_type5");
