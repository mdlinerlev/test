...
class ml_settings extends CModule
{
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage(/*MODULE_LANG_PREFIX*/'ML_SETTINGS' . '_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage(/*MODULE_LANG_PREFIX*/'ML_SETTINGS' . '_MODULE_DESCRIPTION');
    ...
    {
        return [
            '\Ml\Settings\Model\PropertyTable',
        ];
    }
